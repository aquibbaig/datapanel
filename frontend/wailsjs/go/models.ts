...
export namespace postgres {
	...
	export class SchemaContext {
	    ...
	    totalTables: number;
	    truncated: boolean;
	    requestedTables: SchemaContextTable[];
	    loadedTables: SchemaContextTable[];
	    missingTables: SchemaContextTable[];
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.requestedTables = this.convertValues(source["requestedTables"], SchemaContextTable);
	        this.loadedTables = this.convertValues(source["loadedTables"], SchemaContextTable);
	        this.missingTables = this.convertValues(source["missingTables"], SchemaContextTable);
	        this.invalidTables = this.convertValues(source["invalidTables"], SchemaContextTable);
